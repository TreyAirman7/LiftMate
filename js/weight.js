...
const WeightManager = (() => {
    ...
    const renderWeightChart = () => {
        ...
        try {
            // Chart.js Plugin registration handled in the main scripts
            // No need to register them here as they should be loaded from CDN
        } catch (error) {
            console.error('Chart.js plugin error:', error);
        }
